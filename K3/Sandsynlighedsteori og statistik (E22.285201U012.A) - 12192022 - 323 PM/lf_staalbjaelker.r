## Opgave om stålbjælker med metaltræthed


## Oplyst i opgaven: 
# S: Hændelsen at bjælken er svag
# R: Hændelsen at bjælken udviser det særlige mønster ved scanning
p_R_givet_S = 0.87      
...
p_Sc = 1 - p_S        
# P(Sc) = 0.90, da resten (90 pct) er stærke
p_R_givet_Sc = 0.07    
